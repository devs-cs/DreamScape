...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate a story and render animation based on input strings.')
    parser.add_argument('strings', nargs='+', help='Input strings for story generation.')
    args = parser.parse_args()

    input_strings = args.strings

    stories = story.generate_story(input_strings)
